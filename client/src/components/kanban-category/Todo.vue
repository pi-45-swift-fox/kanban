<template id="">
    <div class="kanban">
      ...
      <div class="overflow-auto kanban-main">
        <div v-for="data in todoProps" :key="data.id" class="card">
          <div class="card-body">
      ...
      <div class="kanban-foot rounded-bottom">
        ...
        <form @submit.prevent="postTodo" id="form-kanban-todo" class='form-kanban' v-show="showForm">
...
<script type="text/javascript">
  ...
  export default {
    ...
    methods: {
      toggleForm()
      {
        document.getElementById("form-kanban-todo").reset();
