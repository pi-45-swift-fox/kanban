<template id="">
    <div class="kanban">
      ...
      <div class="overflow-auto kanban-main">
        <div v-for="data in completedProps" :key="data.id" class="card">
          <div class="card-body">
      ...
      <div class="kanban-foot rounded-bottom">
        ...
        <form @submit.prevent="postCompleted" id="form-kanban-completed" class='form-kanban' v-show="showForm">
...
<script type="text/javascript">
  ...
  export default {
    ...
    methods: {
      toggleForm()
      {
        document.getElementById("form-kanban-completed").reset();
